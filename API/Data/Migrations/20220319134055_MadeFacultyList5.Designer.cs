...
namespace API.Data.Migrations
{
    ...
    [Migration("20220319134055_MadeFacultyList5")]
    partial class MadeFacultyList5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Faculty", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Faculty");
                });
            ...
            modelBuilder.Entity("API.Entities.TeacherFaculty", b =>
                {
                    b.HasBaseType("API.Entities.Faculty");

                    b.ToTable("Faculties");

                    b.HasDiscriminator().HasValue("TeacherFaculty");
                });
            ...
            modelBuilder.Entity("API.Entities.Teacher", b =>
                {
                    b.HasOne("API.Entities.TeacherFaculty", "Faculty")
                        .WithMany("Teachers")
                        .HasForeignKey("FacultyId")
